    ...
    <footer className={`text-[var(--white)] mt-20 ${path === "/dashboard" ? 'hidden' : ''}`}>
      <div className="grid grid-cols-4">
        <div className=" col-span-4 md:col-span-2 border-none">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3050.283610055313!2d8.825588625812651!3d40.13596587148613!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12ddb7f87c951441%3A0xd4063408c3b1e9c2!2sParco%20sportivo!5e0!3m2!1sit!2sit!4v1715069970400!5m2!1sit!2sit"
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
          ></iframe>
        </div>
        <div className="col-span-4 md:col-span-1 bg-footer-contact flex flex-col  justify-evenly p-10 ">
          <div>
            <svg
            ...
            <h3 className="text-3xl mt-5">Contattaci</h3>
          </div>

          <div>
            <h4 className="">Roberto</h4>{" "}
            <a href="tel:+393496600822">3487263203</a>
          </div>
          <div>
            <h4 className="">Mirko</h4>{" "}
            <a href="tel:+393496600822">3496600822</a>
          </div>
        </div>
        <div className="col-span-4 md:col-span-1 bg-footer-mail flex flex-col  justify-evenly p-10 ">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <h3 className="text-3xl mt-5">Scrivici una mail</h3>
          </div>
      ...
      <div className="footer grid grid-cols-3 p-10 md:py-20 gap-20 ">
        <div className="col-span-3 md:col-span-1 md:flex md:justify-center  md:w-full">
          ...
          <p>
            Struttura di padel inaugurata nel 2024. Offriamo campi all&rsquo;avanguardia, progettati per garantire un&rsquo;esperienza di gioco eccezionale per tutti i livelli. Venite a scoprire il nostro centro moderno e ben attrezzato.
          </p>
          </div>
        ...
        <div className="col-span-3 md:col-span-1 md:flex md:justify-center  md:w-full ">
          ...
          <ul>
            ...
            <li className="mb-3">
              ...
              <a href="tel:+3487263203">3487263203</a>
            </li>
            <li className="mb-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="mb-3">
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-6 h-6 me-3 inline-block"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        <div className="col-span-3 md:col-span-1 md:flex md:justify-center md:w-full">
          ...
          <div className="flex w-full items-center">
            ...
            <a href="https://www.instagram.com/norbellosportclubtime/" className="me-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="me-3"
                x="0px"
