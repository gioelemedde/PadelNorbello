  ...
  return (
    <Navbar className={`px-4 py-2 lg:px-8 border-none rounded-none fixed top-0 w-full z-50 bg-[var(--dark-blue)] md:border-none`}>
      <div className=" flex items-center justify-between text-[--white]">
        ...
        <div className="hidden lg:block ms-24">{navList}</div>
        <div className="flex items-center gap-x-1 beat">
          <a href="https://api.whatsapp.com/send?phone=+393487263203&text=Ciao%2C%20vorrei%20avere%20informazioni..." target="_blank">
          <Button
            variant="text"
            size="sm"
            className="hidden btn-nav lg:flex items-center rounded-none"
          >
      ...
      <Collapse open={openNav}>
        <div className="container mx-auto">
          ...
          <a className="w-full" href="https://api.whatsapp.com/send?phone=+393487263203&text=Ciao%2C%20vorrei%20avere%20informazioni..." target="_blank">
            <Button
              fullWidth
              variant="text"
              size="sm"
