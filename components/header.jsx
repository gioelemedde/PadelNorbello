...
function Header() {
  return (
    <header className="header grid grid-cols-12 text-[var(--white)] overflow-hidden relative">
      ...
      <div className="col-span-12 md:col-span-6 flex flex-col items-center md:items-start justify-center px-8 h-full ">
        <div className="containerTitle text-center md:text-start mt-10 md:mt-0">
          ...
          Sport Club <br /> Time <span>ASD</span>
        </h1>
        </div> 
        <div className="animationLeft">
          <a href="https://playtomic.io/asd-sport-club-time/d8bd0052-8dc2-48cb-bba2-ba4b99bae9dc?q=PADEL~2024-05-11~~~" target="_blank">
           <button className="btn2 mt-5 md:ms-3 ms-0 uppercase ">Prenota Campo</button>
           </a>
        </div>
      </div>
